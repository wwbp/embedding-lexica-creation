...
print("Preparing {}".format(args.output_file))
...
word_vectors_type='crawl-300d-2M.vec'
    
vec.extract_embeddings_for_fasttext(word_vectors_type)
...
#Yilin Geng
# elif args.word_vectors_type == 'crawl-300d-2M.vec':
#     vec.extract_embeddings_for_fasttext(args.word_vectors_type)
#end
